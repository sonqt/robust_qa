...
do 
    for data in AGent/SQuAD_AGent_dev ACE/ACE-whQA-competitive ACE/ACE-whQA-noncompetitive ACE/ACE-whQA-has-answer SQuAD/squad-attack/dev_adversarial_attack SQuAD/squad-attack/dev_negation_attack
    do
